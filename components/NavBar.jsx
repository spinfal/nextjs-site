                ...
                <>
                    <div className='max-w-7xl mx-auto px-2 sm:px-6 lg:px-8'>
                        <div className='relative flex items-center justify-between h-16'>
                            ...
                            {/* <img src='https://storage.spin.rip/projects/spin.rip/meow.gif' className='w-0 md:w-12 cursor-pointer' loading='lazy' onClick={() => {
                                setVariant(variants[0])
                            }} draggable='false' title='oneko meow' alt='oneko meow' /> */}
                        </div>
                    </div>
                    ...
                    <Disclosure.Panel className='sm:hidden'>
                        <div className='px-2 pt-2 pb-3 space-y-1'>
                            ...
                            {/* <img src='https://storage.spin.rip/projects/spin.rip/meow.gif' className='w-10 md:w-0 hover:animate-pulse cursor-pointer' loading='lazy' onClick={() => {
                                setVariant(variants[0])
                            }} draggable='false' title='oneko meow' alt='oneko meow' /> */}
                        </div>
                    </Disclosure.Panel>
